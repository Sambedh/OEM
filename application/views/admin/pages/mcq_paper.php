...
<?php if(!empty($insert_id)){
    ...
    <form class="form-horizontal form-label-left" id='mcq_form' enctype="multipart/form-data" action='<?php echo base_url('admin/paper');?>' method='post'>
        <?php for ($x=1 ; $x<=$n ; $x++){ ?>
            <div class="row">
...
<?php } elseif(!empty($update_id)) { 
    ...
    <div class="clearfix"></div>
    <form class="form-horizontal form-label-left" enctype="multipart/form-data" action='<?php echo base_url('admin/paper');?>' method='post'>
