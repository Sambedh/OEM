...
<div class="row" >
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            ...
            <div class="x_content mcq">
            <!-- Smart Wizard -->
                <h2>Setup New Question Paper</h2>
                <form class="form-horizontal form-label-left" action="<?php echo base_url('admin/mcq');?>" method="post">
                        ...
                        <div>
                                ...
                                <h5 class="StepTitle" style="text-align: center;">Select Exam</h5>
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-2 col-sm-2">Select Exam
                                        </label>
                                ...
                                <?php 
                                    foreach($exam_subjects as $item):
                                        foreach($item as $detail):
                                            ...
                                            $url = site_url()."admin/mcq?id=".$detail->id."&update=true";
                                            echo "<td>";?>
                                                        ...
                                                        <form action='<?php echo $url ?>' method='post'>
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <?php $paper_url=site_url()."admin/paper?id=".$detail->id; ?>
...
<div id="Delete_Model" class="modal modal-primary" >
    ...
    <div class="modal-dialog">
      <div  class="modal-content">
        ...
        <div class="modal-footer" >
            <form method="post" action="<?php echo base_url('admin/mcq'); ?>" name="deleteForm" >
