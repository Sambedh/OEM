				...
				<ul class="nav side-menu">
					<li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
						<ul class="nav child_menu">
							<li><a href="<?php echo base_url('student');?>"><i class="fa fa-tachometer"></i>Dashboard</a></li>
							<!-- <li><a href="index2.html">Dashboard2</a></li>
							<li><a href="index3.html">Dashboard3</a></li> -->
						</ul>
					</li>
					<li><a href="<?php echo base_url('student/exam');?>"><i class="fa fa-laptop"></i> Exams</a></li>
					<li><a href="<?php echo base_url('student/result');?>"><i class="fa fa-trophy"></i> Examination Results</a></li>
				</ul>
			</div>
		</div>
		<!-- /sidebar menu -->
